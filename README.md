...
There are intentionally **no prices**, **no package tiers**, **no numeric promises** (photo counts, delivery windows) and **no em dashes** on the site. Reviews are kept plain. Keep it that way unless Eddie decides otherwise.
